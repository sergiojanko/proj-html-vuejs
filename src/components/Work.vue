  ...
  <section id="work" class="text-center">
    <div class="container">
      <div class="row">
        ...
        <div class="col-12">
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sunt vero debitis dolorum nostrum, iusto id numquam quibusdam quod error aperiam! Incidunt, quasi hic ratione minus ipsam quaerat exercitationem harum dolores?</p>
        </div>
        <div v-for="img in images" :key="img"  class="col-4">
...
data(){
  return {
    images: [
      ...
      "case-study-gallery-2-600x450.jpg",
